...
DESCRIPTION = "统一配置与密钥中心：KMS/HSM、密钥轮换、证书和动态配置"
...
class Item(BaseModel):
    ...
    owner: str = Field(default="安全平台部", max_length=80)
    priority: Literal["P0", "P1", "P2", "P3"] = "P1"
    status: Literal["planned", "active", "review", "closed"] = "active"

ITEMS: list[dict[str, object]] = [
    {"id": "demo-1", "name": "核心能力基线", "owner": "安全平台部", "priority": "P1", "status": "active", "created_at": datetime.now(UTC).isoformat()},
